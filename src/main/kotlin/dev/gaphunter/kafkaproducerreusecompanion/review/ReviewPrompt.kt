package dev.gaphunter.kafkaproducerreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.kafkaproducerreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.kafkaproducerreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Kafka Producer Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33809-kafka-producer-reuse-companion/reviews"
